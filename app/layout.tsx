...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`dark ${plusJakartaSans.variable} ${jetBrainsMono.variable} scroll-smooth`}
    >
      <head>
      ...
      <body className="bg-[#0d131f] text-[#dde2f4] font-sans antialiased min-h-screen selection:bg-[#4edea3] selection:text-[#003824]">
        {children}
      </body>
    </html>
  );
